...
namespace SmartWeb.ProtoBuffer
{
    public class AlarmService:Job
    {
        ...
        /// 接收报警数据并入库
        /// </summary>
        [Invoke(Begin = "2020-11-11 00:00:00", Interval = 2000)]
        public void ReviceAlarm()
        {
            try
            {
                ...
                for (int i = 0; i < alarmList.Count; i++)
                {
                    ...
                    List<Models.AlarmInfo> list = alarm.alarmInfos;
                        ...
                        try
                        {
                            ...
                            if (flag)
                            {
                                ...
                                if (!ManagerHelp.IsShipPort)
                                {
                                    ...
                                    assembly.SendAlarm("request", alarmInfo, alarm.Id + ":" + webId);
                                }
                            }
                        }
                        catch (Exception ex)
        ...
        /// 向陆地端推送报警数据
        /// </summary>         
        [Invoke(Begin = "2020-11-11 00:00:00", Interval = 1000 * 60 * 3)]
        public void SyncAlarm()
        {
            Task.Factory.StartNew(state =>
            {
                ...
                List<SmartWeb.Models.Alarm> record = new List<SmartWeb.Models.Alarm>();
