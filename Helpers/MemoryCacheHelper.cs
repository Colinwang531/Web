...
namespace Smartweb.Helpers
{
    public class MemoryCacheHelper
    {
        ...
        public void RemoveByValue(string value)
        {
            ...
            var key = GetCacheKeyByValue(value);
            Cache.Remove(key);
        }
        #endregion
        ...
        /// <summary>
        /// 获取value对应的缓存键【根据value获取】
        /// </summary>
        /// <param name="value">cid</param>
        /// <returns></returns>
        public string GetCacheKeyByValue(string value)
        {
            string KeyByValue = string.Empty;
            var cacheKeys = GetCacheKeys();
