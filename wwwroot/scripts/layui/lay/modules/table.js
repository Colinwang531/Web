...
layui.define(["laytpl", "laypage", "layer", "form", "dropdown"], function (e) {
    ...
    M.prototype.config = {
        ...
        if (a.url != null) {
            var nocacheIndex = a.url.indexOf("__dt__for__ie11_nocache");
            if (nocacheIndex > 0) {
                a.url = a.url.substring(0, nocacheIndex - 1);
            }
            a.url += ((a.url.indexOf("?") > 0) ? '&' : '?') + '__dt__for__ie11_nocache=' + new Date();
        }      
        ...
        e.checkbox && (e.type = "checkbox"), e.radio && (e.type = "radio"), e.space && (e.type = "space"), e.type || (e.type = "normal"), "normal" !== e.type && (e.unresize = !0, e.width = e.width || i[e.type])
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            ...
            n.contentType && 0 == n.contentType.indexOf("application/json") && (s = JSON.stringify(s)), t.ajax({
                ...
                data: s,
                dataType: "json",
                headers: n.headers || {}, success: function (t) {
        ...
        var c = this,
            ...
            v = function () {
                return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(u, function (e, a) {
                            ...
                            var y = ['<td data-field="' + r + '" ' + function () {
                                ...
                                return "checkbox" === n.type ? '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" ' + function () {
                                    ...
                                    return n[t] ? (a[t] = n[t], n[t] ? "checked" : "") : e[t] ? "checked" : ""
                                        ...
                                        "radio" === n.type ? '<input type="radio" name="layTableRadio" lay-skin="primary" ' + function () {
                                            var r = d.config.radioName;
                                            return n[r] ? (a[r] = n[r], n[r] ? "checked" : "") : e[r] ? "checked" : ""
                    ...
                    c.scrollPatch()
                }, 50), c.haveInit = !0, void l.close(c.tipsIndex), P.render())
            };
        ...
        var e = this,
            t = e.config;
        if (t.loading && t.url) return l.msg("正在读取数据，请稍后...", {
            icon: 16,
        ...
        u.on("mousemove", function (e) {
        ...
        }), a.elem.on("click", 'input[name="layTableRadio"]+', function () {
            var e = t(this).prev(),
                i = a.layBody.find('input[name="layTableRadio"]'),
                l = e.parents("tr").eq(0).data("index"),
                n = e[0].checked;
            d.cache[a.key][l][d.config.radioName] = n, layui.event.call(this, s, "radio(" + f + ")", {
                checked: n,
            ...
            var e = t(this),
                i = e.scrollLeft(),
                n = e.scrollTop();
            a.layHeader.scrollLeft(i), a.layFixed.find(m).scrollTop(n), l.close(a.tipsIndex), P.hide()
    ...
    }, d.radioStatus = function (e) {
        var t = 0,
            a = [],
            l = d.cache[e] || [];
        return layui.each(l, function (e, l) {
            return void (l[d.config.radioName] && (t++ , a.push(d.clearCacheKey(l))))
        }), {
                data: a
            }
        ...
        return e = t.extend({}, e), delete e[d.config.checkName], delete e[d.config.radioName], delete e[d.config.indexName], e
    }, d.init(), e(s, d)
});